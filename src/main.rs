...
fn themes() -> Vec<ThemeVariant> {
    vec![
        ...
        ThemeVariant {
            name: "rust",
            theme: base(Theme {
                primary_color: "#4a3428".into(),
                primary_text_color: "#e0d0c0".into(),
                primary_border_color: "#6a5040".into(),
                line_color: "#6a5040".into(),
                secondary_color: "#2e1e14".into(),
                tertiary_color: "#1e1512".into(),
                edge_label_background: "#1e1512".into(),
                cluster_background: "#2e1e14".into(),
                cluster_border: "#6a5040".into(),
                sequence_actor_fill: "#4a3428".into(),
                sequence_actor_border: "#6a5040".into(),
                sequence_actor_line: "#6a5040".into(),
                sequence_note_fill: "#4a3428".into(),
                sequence_note_border: "#6a5040".into(),
                sequence_activation_fill: "#2e1e14".into(),
                sequence_activation_border: "#6a5040".into(),
                text_color: "#e0d0c0".into(),
                ..Theme::modern()
            }),
        },
    ]
